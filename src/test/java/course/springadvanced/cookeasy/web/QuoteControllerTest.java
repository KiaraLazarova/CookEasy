...
public class QuoteControllerTest {
    ...
    @Autowired
    public QuoteControllerTest(MockMvc mockMvc, UserRepository userRepository, GenderRepository genderRepository, LevelRepository levelRepository, RoleRepository roleRepository) {
    ...
    public void testRetrieveQuotesPageShouldReturnCorrectView() throws Exception {
        this.mockMvc.
                perform(get("/quotes")).
                andExpect(status().isOk()).
                andExpect(view().name(GlobalTestConstants.QUOTES_PAGE_VIEW_NAME));
    }
}