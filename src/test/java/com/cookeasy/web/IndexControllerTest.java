...
public class IndexControllerTest {
    ...
    @Autowired
    public IndexControllerTest(MockMvc mockMvc, UserRepository userRepository, GenderRepository genderRepository, LevelRepository levelRepository, RoleRepository roleRepository) {
    ...
    @Test
    public void testRetrieveIndexPageShouldReturnIndexView() throws Exception {
        this.mockMvc.
                perform(get("/")).
                andExpect(status().isOk()).
                andExpect(view().name(GlobalTestConstants.INDEX_PAGE_VIEW_NAME));
    }
